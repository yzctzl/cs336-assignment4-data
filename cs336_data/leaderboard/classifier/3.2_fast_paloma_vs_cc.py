...
base_dir = Path("data")
train_file = base_dir / "paloma" / "paloma_cc" / "train.txt"
valid_file = base_dir / "paloma" / "paloma_cc" / "valid.txt"
test_file = base_dir / "paloma" / "paloma_cc" / "test.txt"
model_dir = base_dir / "classifiers"
output_model = model_dir / "paloma_vs_cc_full.bin"
quantize_model = model_dir / "paloma_vs_cc.ftz"
